...
(function(d) {
    function c(a, b) {
        ...
        "none" == c ? this.element.css("transform", "translateZ(0)") : -1 == c.indexOf("matrix3d") && this.element.css("transform",
    ...
    function l() {
        g = !0;
        d(":jquery-stickit").each(function() { d(this).data("jquery-stickit").refresh() });
        setTimeout(function() { g = !1 })
    }

    function p() {
        g = !0;
        d(":jquery-stickit").each(function() { d(this).data("jquery-stickit").locate() });
        setTimeout(function() { g = !1 })
    }
    ...
    function u() {
        ...
        d(":jquery-stickit").each(function() { d(this).data("jquery-stickit").enableWillChange(!a) })
    }
    ...
    var q = -1 != navigator.userAgent.indexOf("MSIE 7.0"),
        ...
        h = window.StickScope = { Parent: 0, Document: 1 },
        e = { None: 0, Fixed: 1, Absolute: 2 },
        t = !1,
        g = !1;
    d.expr[":"]["jquery-stickit"] = function(a) { return !!d(a).data("jquery-stickit") };
    c.prototype.trigger =
        function(a) {
    ...
    c.prototype.isActive = function(a) { return (void 0 === a.screenMinWidth || k >= a.screenMinWidth) && (void 0 === a.screenMaxWidth || k <= a.screenMaxWidth) };
    c.prototype.updateCss = function(a) {
        ...
        this.stick == e.Absolute ?
            this.options.extraHeight != a.extraHeight && (b.bottom = -this.options.extraHeight + "px") : this.options.top != a.top && (b.top = a.top + this.offsetY + "px");
    ...
    c.prototype.getZIndex = function(a) { return void 0 === a.zIndex ? this.defaultZIndex : a.zIndex };
    c.prototype.getActiveOptionsKey = function() { for (var a = [], b = 0; b < this.optionList.length; ++b) this.isActive(this.optionList[b]) && a.push(b); return a.join("_") };
    ...
    c.prototype.bound = function() {
        ...
        if (q || "border-box" != a.css("box-sizing")) this.extraWidth = 0;
            ...
            var b = parseFloat(a.css("border-left-width")) ||
                0,
        ...
        this.margin = { top: parseFloat(a.css("margin-top")) || 0, bottom: parseFloat(a.css("margin-bottom")) || 0, left: parseFloat(a.css("margin-left")) || 0, right: parseFloat(a.css("margin-right")) || 0 };
        this.parent = { border: { bottom: parseFloat(a.parent().css("border-bottom-width")) || 0 } }
    };
    c.prototype.precalculate = function() {
        this.baseTop = this.margin.top + this.options.top;
        this.basePadding =
            this.baseTop + this.margin.bottom;
    ...
    c.prototype.setFixed = function(a, b, c) {
        ...
        this.lastY = b;
        this.offsetY = c;
        this.element.css({ width: this.element.width() + this.extraWidth + "px", position: "fixed", top: this.options.top + c + "px", left: a + "px", bottom: this.origStyle.bottom, "z-index": this.zIndex })
    };
    c.prototype.updateScroll = function(a) {
        if (0 != this.offsetHeight && this.options.overflowScrolling) {
            ...
            this.lastY = a;
            this.offsetY !=
                b && (this.offsetY = b, this.element.css("top", this.options.top + this.offsetY + "px"))
        }
    };
    c.prototype.isHigher = function() { return this.options.scope == h.Parent && this.element.parent().height() <= this.element.outerHeight(!1) + this.basePadding };
        ...
        if (this.activeKey) {
            ...
            switch (this.stick) {
                case e.Fixed:
                    ...
                    0 <= b || this.isHigher() ? this.reset() : this.options.scope == h.Parent ? (a = d.parent()[0].getBoundingClientRect(),
                        a.bottom + this.baseParentOffset + this.offsetHeight <= d.outerHeight(!1) + this.basePadding ? this.setAbsolute(this.spacer.position().left) : this.updateScroll(a.bottom)) : this.updateScroll(a.bottom);
                    break;
                case e.Absolute:
                    a = f[0].getBoundingClientRect();
                    b = a.top - this.baseTop;
    ...
    c.prototype.enableWillChange =
        function(a) { "auto" == this.origWillChange && this.element.css("will-change", a ? "transform" : this.origWillChange) };
    ...
    d.fn.stickit = function(a, b) {
        if ("string" == typeof a) {
            ...
            d(document.body).bind("animationend webkitAnimationEnd oAnimationEnd transitionend webkitTransitionEnd oTransitionEnd",
                p);
            d(document).bind("webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange", u)
        }), w && (new MutationObserver(v)).observe(document, { attributes: !0, childList: !0, characterData: !0, subtree: !0 })), b = d.isArray(a) ? a : Array.prototype.slice.call(arguments, 0), this.each(function() {
            var a = new c(this, b);
